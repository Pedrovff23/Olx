...
public class AdapterAnunciosPublicos extends RecyclerView.Adapter<AdapterAnunciosPublicos.MyViewHolder> {

    private final List<Anuncio> adapterAnuncios;
    private final Context context;

    public AdapterAnunciosPublicos(List<Anuncio> adapterAnuncios, Context context) {
